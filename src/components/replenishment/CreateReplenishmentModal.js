        ...
        <form onSubmit={(e) => e.preventDefault()} className="p-5 flex-1 flex flex-col min-h-0 space-y-4">
          ...
          <div className="justify-end space-x-2 flex flex-shrink-0 pt-2 text-xs">
            ...
            <button
              ...
              className="px-4 py-1.5 bg-gray-900/50 text-white rounded-custom hover:bg-gray-900 transition-colors text-sm flex items-center disabled:opacity-50 font-medium"
            >
              {isSubmitting ? (
                <>
