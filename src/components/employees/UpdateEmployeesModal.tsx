...
import { Employee, UpdateEmployeesModalProps, initialFormState } from '../../interface/employee.tsx';

const UpdateEmployeesModal: React.FC<UpdateEmployeesModalProps> = ({ showEditModal, setShowEditModal, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-custom shadow-xl border border-gray-200 w-full max-w-2xl flex flex-col max-h-[90vh]">
        ...
        {/* Header Section */}
        <FormHeader headerTitle="Update Employee Record" onClick={handleCancel} />
