...
export const getInventoryTableListSearch = async (params = {}) => {
  try {
    // Validate and build query parameters
    const queryParams = new URLSearchParams();
...
export const getInventoryReplenishmentListsearch = async (params = {}) => {
  try {
    // Validate and build query parameters
    const queryParams = new URLSearchParams();
...
export const getInventoryBatchesListSearch = async (params = {}) => {
  try {
    // Validate and build query parameters
    const queryParams = new URLSearchParams();
